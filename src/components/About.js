...
const About = () => {
    return (
        <section className="about">
            <h2>About Me</h2>
            <p>
I have over a decade of experience in bioinformatics, computational biology, and digital biosecurity. I helped develop the field of digital biosecurity and the related field of cyberbiosecurity. I have dedicated my career to advancing scientific innovation and tackling complex challenges in the field of functional genomics. As a staff member and manager at Sandia National Laboratories, I have led numerous high-impact projects, including cutting-edge gene editing and annotation technologies. I have also applied machine learning, advanced algorithms and artificial intelligence to significant biological problems. My work has resulted in 30 peer-reviewed publications and numerous presentations at prestigious conferences, showcasing my commitment to advancing our understanding of genomics, computationl biology and biosecurity.
</p><p>
My role as a Program Manager at DARPA and my leadership and management positions at Sandia National Laboratories have equipped me with the skills to manage complex projects, develop innovative technologies, and foster collaborative research efforts. I have successfully led teams of computational and experimental biologists, driving forward initiatives that integrate advanced algorithms, secure computation, and machine learning to enhance the cybersecurity of biological operations and generate novel biological insights.
</p><p>
